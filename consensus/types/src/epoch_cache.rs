...
impl EpochCache {
    pub fn new(
        ...
        //let first_value = if !base_rewards.is_empty() {
        //    base_rewards[0]
        //} else {
        //    0
        //};
        println!("Original base_rewards length: {}", base_rewards.len());
        println!("Original base_rewards values[1]: {}", base_rewards[1]);
        //if base_rewards.len() < 3001 {
        //    //info!(logger, "Resizing base_rewards array"; "original_length" => base_rewards.len(), "first_value" => first_value);
        //    base_rewards.resize(3001, first_value);
            //info!(logger, "Resized base_rewards array"; "new_length" => base_rewards.len(), "first_value" => first_value, "second_value" => base_rewards[1]);
        //}
        //println!("Resized base_rewards length: {}", base_rewards.len());
        //println!("Second value: {}", base_rewards[1]);
        Self {
